...
using System.Drawing; // devi installarlo => dotnet add package System.Drawing.Common
using System.IO;
using System.Text;
...
public class PythonRunner
{
      ...
      { 
         ...
         var pi = new ProcessStartInfo
         {
            ...
            FileName = "cmd.exe",
            Arguments = $"/c C:/Users/Matteo/anaconda3/condabin/conda.bat activate {Environment}&&python {strCommand}",
            UseShellExecute = false, 
            CreateNoWindow = false,
            ErrorDialog = false,
            RedirectStandardError = true, //chiede ridirezione di errori 
            RedirectStandardOutput = true, //chiede ridirezione di output
            RedirectStandardInput = true, //chiede ridirezione di input
         };         

         //qua attiva un nuovo processo e gli fa fare le cose 
                                           ...
                                           })
         {
            process.OutputDataReceived += (sender, e) =>
            {
               ...
               if (e.Data != null)
               {
                  ...
                  _outputBuilder.AppendLine(e.Data); //ogni riga di output è appesa qui
               }
            };
